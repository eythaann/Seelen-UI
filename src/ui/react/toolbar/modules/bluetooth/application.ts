import {
  ...
  type BluetoothAudioVideoMinor,
  type BluetoothComputerMinor,
  type BluetoothDevice,
  type BluetoothHealthMinor,
  BluetoothImagingMinor,
  type BluetoothMinorClass,
  type BluetoothNetworkMinor,
  type BluetoothPeripheralMinor,
  type BluetoothPeripheralSubMinor,
  type BluetoothPhoneMinor,
  type BluetoothToyMinor,
  type BluetoothWearableMinor,
...
const FUNC_BY_MAJOR: FuncByMajor = {
  ...
  Imaging: ([minors, _subminor]) => {
    ...
    if (minors.includes(BluetoothImagingMinor.Scanner) || minors.includes(BluetoothImagingMinor.Printer)) {
